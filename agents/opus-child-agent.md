...
| 情報                       | 説明                                                             | 例                                                         |
| -------------------------- | ---------------------------------------------------------------- | ---------------------------------------------------------- |
| **ドキュメント出力先パス** | 作業報告を出力する絶対パス（親が作成済み・検証済み）             | `/docs/main/tasks/devcontainer/タスク名/001-2/`            |
...
- ドキュメント出力先: /docs/main/tasks/devcontainer/タスク名/001-2/
- タスク名: 機能実装
- DOCS_ROOT: /docs
- タスク実行履歴: /docs/main/tasks/devcontainer/タスク名/タスク実行履歴.md （親エージェントが管理）
