...
| 情報                       | 説明                                                             | 例                                                   |
| -------------------------- | ---------------------------------------------------------------- | ---------------------------------------------------- |
| **ドキュメント出力先パス** | 作業報告を出力する絶対パス（親が作成済み・検証済み）             | `/docs/main/devcontainer/タスク名/001-2/`            |
...
| **タスク実行履歴パス**     | タスク実行履歴.mdの絶対パス（タスクフォルダ配下・親が管理）      | `/docs/main/devcontainer/タスク名/タスク実行履歴.md` |
...
```
{DOCS_ROOT}/{ブランチ名}/{ワークスペースフォルダ名}/{タスク名}/{サブディレクトリ}/
```

例：

```
/docs/main/devcontainer/機能追加/001-2/
```
...
- 出力先パス: `/docs/main/devcontainer/タスク名/001-2/`
- ファイル名: `child-タスク名.md`
- 完全なパス: `/docs/main/devcontainer/タスク名/001-2/child-タスク名.md`
...
- ドキュメント出力先: /docs/main/devcontainer/タスク名/001-2/
- タスク名: 機能実装
- DOCS_ROOT: /docs
- タスク実行履歴: /docs/main/devcontainer/タスク名/タスク実行履歴.md （親エージェントが管理）
